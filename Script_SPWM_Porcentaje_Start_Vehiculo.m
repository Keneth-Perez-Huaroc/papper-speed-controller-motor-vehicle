...
Frecuencia_PWM=1000 %(Hertz, Número de pulsos generados en un segundo) Frecuencias aceptables 1000,2000,2500,4000,5000,8000,10000,12500,20000,25000,40000,50000,62500,*80000*,100000 ya que generan periodos PWM decimales no periodicos como 166.666666... ya que generan tamaños de matrices diferentes
...
for i=1:1:Pulsos_por_Ciclo
   ...
   tiempos_microsegundos_Onda_Senoidal_A_arduino=[tiempos_microsegundos_Onda_Senoidal_A_arduino;zeros(double(round(tiempos_OFF_microsegundos_Onda_Senoidal_A(i))),1)];
   ...
   tiempos_microsegundos_Onda_Senoidal_B_arduino=[tiempos_microsegundos_Onda_Senoidal_B_arduino;zeros(double(round(tiempos_OFF_microsegundos_Onda_Senoidal_B(i))),1)];
   ...
   tiempos_microsegundos_Onda_Senoidal_C_arduino=[tiempos_microsegundos_Onda_Senoidal_C_arduino;zeros(double(round(tiempos_OFF_microsegundos_Onda_Senoidal_C(i))),1)];
end
